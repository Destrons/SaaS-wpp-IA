...
class ConversationalService{
    ...
    public function showInsights()
    {
        $now = now();
        $messages = [
            ["role" => "user", "content" => "Aja como um assistente pessoal, hoje é $now, entenda o historico de rotina do usuario e gere insights sobre sua rotina, onde ele pode melhorar e oque ele pode fazer para otimizar"],
 ...
 public function showUpdate()
    ...
    {
        return $this->user->tasks()->where('due_at', '>', now()
        ->subDays($days))
        ->get();
    }
    ...
    public function updateUserTask(...$params)
    {
        /*if (!isset($params['taskid'])){
            return "O campo 'taskid' é obrigatório";
        }*/
                ...
                [
                    ...
                    'parameters' => [
                        ...
                        'properties' => [
                            ...
                            'meta' => [
                                'type' => 'string',
                                'description' => 'Metadados da tarefa solicitada pelo usuario que o chatgpt ache interessante para posteriormente gerar  insights sobre a rotina do usuario este campo e obrigatorio. Ex: reuniao de negocios: Discussao de projetos'
                            ],
                            'reminder_at' => [
                                'type' => 'string',
